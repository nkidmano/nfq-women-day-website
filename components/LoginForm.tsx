...
const LoginForm = () => {
  ...
  return (
    <div className="w-[500px] max-w-full flex flex-col space-y-4 justify-center items-center">
      <p className="md:text-2xl">Enter your NFQ email: </p>
      ...
      <p className="md:text-2xl">Select location:</p>
      <Select onValueChange={(value) => setLocation(value)}>
        <SelectTrigger className="w-full bg-white p-6 rounded-full md:text-xl shadow-none">
      ...
      <div className="w-full flex justify-end items-center !mt-8">
        <Button
          ...
          className={`w-full md:text-xl h-[50px] rounded-full shadow-none bg-pink-500 hover:bg-pink-600 ${isSubmitting ? 'cursor-not-allowed opacity-70' : ''}`}
        >
